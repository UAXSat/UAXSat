...
def read_uv_sensor():
    try:
        ...
        logging.error(f"Error reading UV Sensor: {e}", exc_info=True)
        return None
...
def read_imu_sensor():
    try:
        ...
        logging.error(f"Error reading IMU Sensor: {e}", exc_info=True)
        return None
...
def read_dallas_sensor():
    try:
        ...
        log_status("DallasSensor", "Disconnected")
        logging.error(f"Error reading Dallas Sensor: {e}", exc_info=True)
        return None
...
def read_CPU():
    try:
        ...
        logging.error(f"Error reading CPU Temperature: {e}", exc_info=True)
        return None
...
def read_CPU_usage():
    try:
        ...
        logging.error(f"Error reading CPU Usage: {e}", exc_info=True)
        return None
...
def read_RAM_usage():
    try:
        ...
        logging.error(f"Error reading RAM Usage: {e}", exc_info=True)
        return None
...
def read_gps_sensor(gps_parser):
    try:
        ...
        log_status("GPS Sensor", "Disconnected")
        logging.error(f"Error reading GPS Sensor: {e}", exc_info=True)
        return None
